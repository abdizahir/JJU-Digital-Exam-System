...
<div class="header">
    <div class="row">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;Hello,</span>
         <a href="teacher.php" class="log log1">'.$email.'</a>
         &nbsp;|&nbsp;<a href="homepage.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
        }?>
    </div>
</div>
...
<nav class="navbar navbar-default title1">
    <div class="container-fluid">
        ...
        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
            ...
            <a class="navbar-brand" href="teacher.php?q=0"><b>Dashboard - TEACHER</b></a>
        </div>
        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="teacher.php?q=0">Home<span class="sr-only">(current)</span></a></li>
                <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="teacher.php?q=1">Scores</a></li>  
                <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="teacher.php?q=2">Ranking</a></li>
                <!---- <li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="teacher.php?q=3">Feedback</a></li>  ---->
                <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active'; ?>">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Quiz<span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="teacher.php?q=4">Add Quiz</a></li>
                    <li><a href="teacher.php?q=5">Remove Quiz</a></li>
                </ul>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
